...
def get_args_parser(add_help = True):
    ...
    parser.add_argument('--teacher-model-path', type=str, default='./ckpt/Fold1/GGEConvNet_Large/Epoch99_GGEConvNet_Large_0.9000.pth', help='Path to the teacher model checkpoint.')
