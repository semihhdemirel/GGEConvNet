...
def get_args_parser(add_help = True):
    ...
    parser.add_argument('--model', type=str, default='GGEConvNet_Small', help='Name of the student model to train. Default: GGEConvNet_Small, Options: GGEConvNet_Small, GGEConvNet_Large')
